    ...
    return `
      <article class="project-card reveal" data-categories="${escapeHtml(project.categories.join('|'))}" data-video-id="${escapeHtml(project.videoId)}" data-video-title="${escapeHtml(project.title)}">
        <div class="project-card__media">
          <a class="project-card__link" href="/concept/work/${encodeURIComponent(project.slug)}/" aria-label="Open project: ${escapeHtml(project.title)}">
        ...
        <details class="project-card__details">
          ...
          <p>${escapeHtml(project.cardDescription)} <a class="button button--text" href="/concept/work/${encodeURIComponent(project.slug)}/">Open project</a></p>
        </details>
      </article>`;
  }
